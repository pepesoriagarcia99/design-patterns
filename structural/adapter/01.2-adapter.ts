...
// Estrategia de pago que utiliza el adaptador para procesar los pagos
// class PayService {
//   constructor(private paymentStrategy: PaymentProcessor) {}
...
function main() {
  ...
  // puedo cambiar el proceso de pago
  // const payService = new PayService(paypalProcessor);
